...
/**
 ...
 We don't do this however, as it would effectifely double the memory footprint
 of path data.
...
struct PathElement {
  ...
  /// Returns a new path element define the span from the reciever to the new vertex.
  ...
  /// Splits an element span defined by the reciever and fromElement to a position 0-1
