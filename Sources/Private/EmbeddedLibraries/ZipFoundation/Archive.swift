...
internal let defaultReadChunkSize = Int(16*1024)
/// The default chunk size when writing entry data to an archive.
internal let defaultWriteChunkSize = defaultReadChunkSize
/// The default permissions for newly added entries.
internal let defaultFilePermissions = UInt16(0o644)
/// The default permissions for newly added directories.
internal let defaultDirectoryPermissions = UInt16(0o755)
...
public final class Archive: Sequence {
    ...
    internal enum ArchiveError: Error {
    ...
    internal let accessMode: AccessMode
    ...
    internal init(url: URL, accessMode mode: AccessMode, pathEncoding: String.Encoding? = nil) throws {
        self.url = url
    ...
    internal init(data: Data = Data(), accessMode mode: AccessMode, pathEncoding: String.Encoding? = nil) throws {
    ...
    internal func makeIterator() -> AnyIterator<Entry> {
