...
extension Archive {
    ...
    internal func totalUnitCountForRemoving(_ entry: Entry) -> Int64 {
    ...
    /// - Returns: The number of the work units.
    internal func totalUnitCountForReading(_ entry: Entry) -> Int64 {
        switch entry.type {
        case .file, .symlink:
    ...
    /// - Parameter entry: The entry that will be removed.
    /// - Returns: The number of the work units.
    internal func totalUnitCountForAddingItem(at url: URL) -> Int64 {
        var count = Int64(0)
        do {
