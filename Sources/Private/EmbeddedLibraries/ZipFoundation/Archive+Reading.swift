...
extension Archive {
    ...
    internal func extract(_ entry: Entry, to url: URL, bufferSize: Int = defaultReadChunkSize,
    ...
    /// - Returns: The checksum of the processed content or 0 if the `skipCRC32` flag was set to `true`..
    /// - Throws: An error if the destination file cannot be written or the entry contains malformed content.
    internal func extract(_ entry: Entry, bufferSize: Int = defaultReadChunkSize, skipCRC32: Bool = false,
