...
internal struct Entry: Equatable {
    ...
    internal func path(using encoding: String.Encoding) -> String {
    ...
    internal var compressedSize: UInt64 {
    ...
    internal var uncompressedSize: UInt64 {
        if centralDirectoryStructure.isZIP64 {
