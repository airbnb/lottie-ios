...
internal enum CompressionMethod: UInt16 {
...
internal typealias CRC32 = UInt32
...
internal typealias Consumer = (_ data: Data) throws -> Void
...
internal typealias Provider = (_ position: Int64, _ size: Int) throws -> Data
...
extension Data {
    ...
    internal func crc32(checksum: CRC32) -> CRC32 {
        #if canImport(zlib)
